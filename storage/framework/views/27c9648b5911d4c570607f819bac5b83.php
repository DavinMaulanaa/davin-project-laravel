...
<body class="bg-black overflow-x-hidden relative">
    ...
    <nav class="relative w-full h-32 bg-gradient-to-b from-purple-900/90 to-purple-900/30 flex items-center justify-start px-5 shadow-md">
        ...
        <div class="flex justify-center w-full">
            ...
            <a href="<?php echo e(route('login')); ?>" class="text-xl text-white px-4 mx-1 leading-[50px] transition-colors duration-300 hover:text-purple-900">CARS</a>
            <a href="#" class="text-xl text-white px-4 mx-1 leading-[50px] transition-colors duration-300 hover:text-purple-900">GALLERY</a>
            <a href="<?php echo e(route('about')); ?>" class="text-xl text-white px-4 mx-1 leading-[50px] transition-colors duration-300 hover:text-purple-900">ABOUT</a>
        </div>
    </nav>
...
</html><?php /**PATH C:\Users\ASUS\Downloads\KELAS_11\MK3A\laravel1 lg\davin-project-laravel1\resources\views/index.blade.php ENDPATH**/ ?>